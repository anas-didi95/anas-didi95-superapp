...
public final class CommonConstants {
  ...
  public static final String DTO_IN = "in";
  public static final String DTO_OUT = "out";
  public static final String DTO_OPTS = "opts";
  public static final String DTO_ISERROR = "isError";
}
